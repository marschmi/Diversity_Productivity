...
musk_surface_pruned_rm30 <- prune_taxa(taxa_sums(musk_surface_pruned) > 30, musk_surface_pruned) 
musk_surface_pruned_rm30
notree_musk_surface_pruned_rm10 <- phyloseq(tax_table(musk_surface_pruned_rm30), otu_table(musk_surface_pruned_rm30), sample_data(musk_surface_pruned_rm30))
...
```{r calc-div}
erp10 <- calc_diversity(physeq = notree_musk_surface_pruned_rm10)


test10 <- calc_mean_alphadiv(physeq = notree_musk_surface_pruned_rm1,
                           richness_df = erp10$Richness, 
                           evenness_df = erp10$Inverse_Simpson, 
                           shannon_df = erp10$Shannon) %>%
...
# Read in previously calculated alphadiv values and fix factor levels
otu_alphadiv_rm1 <- calc_mean_alphadiv(physeq = notree_musk_surface_pruned_rm1,
                           richness_df = read.table("../data/metadata/otu_richness100_rm1_rarefy2827", header = TRUE), 
                           evenness_df = read.table("../data/metadata/otu_evenness100_rm1_rarefy2827", header = TRUE), 
                           shannon_df = read.table("../data/metadata/otu_shannon100_rm1_rarefy2827", header = TRUE)) %>%
    mutate(fraction = factor(fraction, levels = c("WholePart", "Particle", "WholeFree", "Free")),
         lakesite = factor(lakesite,  levels = c("MOT", "MDP", "MBR", "MIN")),
         measure = factor(measure, levels = c("Richness", "Simpsons_Evenness", "Shannon_Entropy", "Inverse_Simpson")),
         Removed = "1-tons")  
...
otu_alphadiv_rm5 <- calc_mean_alphadiv(physeq = notree_musk_surface_pruned_rm5,
                           richness_df = read.table("../data/metadata/otu_richness100_rm5_rarefy2827", header = TRUE), 
                           evenness_df = read.table("../data/metadata/otu_evenness100_rm5_rarefy2827", header = TRUE), 
                           shannon_df = read.table("../data/metadata/otu_shannon100_rm5_rarefy2827", header = TRUE)) %>%
    mutate(fraction = factor(fraction, levels = c("WholePart", "Particle", "WholeFree", "Free")),
         lakesite = factor(lakesite,  levels = c("MOT", "MDP", "MBR", "MIN")),
         measure = factor(measure, levels = c("Richness", "Simpsons_Evenness", "Shannon_Entropy", "Inverse_Simpson")),
         Removed = "5-tons")  
...
otu_alphadiv_rm10 <- calc_mean_alphadiv(physeq = notree_musk_surface_pruned_rm10,
                           richness_df = read.table("../data/metadata/otu_richness100_rm10_rarefy2827", header = TRUE), 
                           evenness_df = read.table("../data/metadata/otu_evenness100_rm10_rarefy2827", header = TRUE), 
                           shannon_df = read.table("../data/metadata/otu_shannon100_rm10_rarefy2827", header = TRUE)) %>%
    mutate(fraction = factor(fraction, levels = c("WholePart", "Particle", "WholeFree", "Free")),
         lakesite = factor(lakesite,  levels = c("MOT", "MDP", "MBR", "MIN")),
         measure = factor(measure, levels = c("Richness", "Simpsons_Evenness", "Shannon_Entropy", "Inverse_Simpson")),
         Removed = "10-tons") 
