...
ggplot(free_meta_data, aes(x = D1, y = tot_bacprod)) + 
  geom_point() + geom_smooth(method = "lm")

ggplot(part_meta_data, aes(x = D1, y = tot_bacprod)) + 
  geom_point() + geom_smooth(method = "lm")
