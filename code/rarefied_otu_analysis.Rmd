...
## PER CELL
```{r per-cell, eval = TRUE, fig.width = 10, fig.height = 4, warning = FALSE}
...
```{r fracprod_percell-vs-div, eval = TRUE, fig.width = 10, fig.height = 5, warning = FALSE}
# Can fractional production be predicted by richness? 
...
```{r div_vs_seqdepth, fig.width=10, fig.height = 4, eval = FALSE}
