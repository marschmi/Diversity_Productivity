...
```{r LOOCV-MSE, fig.height=4, fig.width=7 , dependson = c("plot-vegan-fracprod")}
######################################################### RICHNESS
...
## Multicollinearity
```{r, fig.height=4, fig.width=10 , dependson = c("LOOCV-MSE", "post-hoc")}
...
# Alternate: Fig 3
```{r alt-fig3, fig.width = 4, fig.height = 10.25, dependson=c("indepswap-fig-3", "indepswap-fig-4")}
