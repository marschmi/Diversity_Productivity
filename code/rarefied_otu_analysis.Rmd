...
# Figure 3
```{r fig-3, dependson = c("taxa-labels","taxalab-vs-fracprod", "taxalab-fractions")}
# Plot it altogether 
plot_grid(unweightedMPD_vs_fracprod_taxlab + ggtitle("") +
          ...
          unweightedMNTD_vs_fracprod_taxlab + ggtitle("") +
            xlab("Unweighted Mean Nearest Taxon Distance") +
            theme(legend.position = "none"), 
          taxlab_weight_mpd + coord_flip() + xlab("Fraction \n") +
            theme(axis.text.y = element_blank()), 
          taxlab_weight_mntd + coord_flip() + xlab("Fraction \n") +
            theme(axis.text.y = element_blank()), 
          labels = c("A", "B", "C", "D"), 
          ncol = 2, nrow = 2)
```
