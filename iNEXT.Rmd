...
## 1. Extract the R2 and p-value from the linear model: 
lm_percell_prod_vs_rich_PA <- lm(log10(fracprod_per_cell_noinf) ~ richness, data = filter(wide_div_meta_df, fraction == "Particle"))
...
## 1. Extract the R2 and p-value from the linear model: 
lm_percell_prod_vs_shannon_PA <- lm(log10(fracprod_per_cell_noinf) ~ shannon, data = filter(wide_div_meta_df, fraction == "Particle"))
...
## 1. Extract the R2 and p-value from the linear model: 
lm_percell_prod_vs_invsimps_PA <- lm(log10(fracprod_per_cell_noinf) ~ simpson, data = filter(wide_div_meta_df, fraction == "Particle"))
