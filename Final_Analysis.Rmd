...
## Figure S7
```{r plot-station-diversity, fig.width = 9, fig.height = 5, dependson = c("calc-div", "calc-sesmpd")}
# Test by station
...
```{r plot-div, fig.width = 14, fig.height = 3.75, dependson= c("calc-div", "prepare-data")}
...
divs_PAFLA_plot <- ggplot(long_div_df, aes(y = mean, x = lakesite, shape = lakesite)) +
...
plot_grid(divs_PAFLA_plot, lakesite_legend,
          nrow = 2, ncol = 1, 
          rel_heights = c(1, 0.05))
