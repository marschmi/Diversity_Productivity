...
lb1 <- paste("atop(R^2 ==", round(summary(lm_percell_prod_vs_invsimps_PA)$adj.r.squared, digits = 2), ",",
...
percell_prod_vs_invsimps_plot <- 
  ...
  scale_x_continuous(limits = c(0,85), breaks = seq(from = 0, to = 85, by = 20)) + 
  #scale_y_continuous(limits = c(-8e-7,5e-6), breaks = seq(from = 0, to = 6e-7, by = 3e-7)) + 
  annotate("text", x=70, y=-7.5, label=lb1, parse = TRUE, color = "#FF6600", fontface = "bold",size = 4) +
  #annotate("text", x = 70, y = -7.75, label = lb2, parse = FALSE, color = "#FF6600", fontface = "bold",size = 4) + 
...
```{r r2-plotting, fig.width=4, fig.height=4}
...
ggplot(meta_data_PD, aes(y = PD, x = SR)) + 
  ...
  geom_smooth(method = "lm") +
    annotate("text", x = 600, y=35, color = "black", fontface = "bold",
