...
## Figure 2
```{r Figure_2, fig.width = 7, fig.height = 7, dependson= "calc-div"}
######################################################### OBSERVED RICHNESS ######################################################### 
...
As we can see in Figure 2 and Table S1, there is much less variation explained in this model by a linear regression. Here, the result of the "one-standard-error" approach shows that the lasso is unable to stably pick one variable.  Therefore, no variables are chosen.
...
```{r Figure_S4, fig.width = 14, fig.height = 7, dependson= c("calc-div", "prepare-data-lasso")}
...
```{r Figure_S5, fig.width = 7, fig.height = 7, dependson = "calc-div"}
######################################################### SHANNON ENTROPY ######################################################### 
