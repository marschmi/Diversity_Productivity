...
################################################################################## iNEXT ON OLIGOTYPES 
# Read in the phyloseq object to R
load(phyloseq_object) 

# Calculate observed richness, chao1, shannon and simpson Hill Diversity estimates with iNEXT function 
phenoflow_diversity <- Diversity_16S(get(ls()), R=100, brea = FALSE) # 100 bootstraps and do not do breakaway analysis
