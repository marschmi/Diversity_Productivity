...
a <- ggplot(all_flow_cy, aes(x = cells_per_uL, y = LNA_per_uL, fill = Site, color = Site, shape = Season)) + 
  geom_point(size = 3.5) + ggtitle("LNA per uL") + 
  scale_color_viridis(option = "viridis", discrete = TRUE)

b <- ggplot(all_flow_cy, aes(x = cells_per_uL, y = LNA_percent, fill = Site, color = Site, shape = Season)) + 
...
p3 <- plot_grid(p1, p2, p3, p4, 
          labels = c("A", "B", "C", "D"), 
          align = "h", nrow = 2, ncol = 2)

ggsave("Figures/HNA_LNA.png", p3, dpi = 600, units = "in", width = 10, height = 8)
