...
# Write the files 
#write.csv(peter_otu_counts, "peter/muskegon_absolute_otu_counts.csv")
#write.csv(peter_otu_proportion, "peter/muskegon_otu_proportions.csv")

HNA_prod3 <- HNA_prod2 %>%
  select(norep_filter_name, lakesite, limnion, year, 
         tot_bacprod,
...
#write.csv(HNA_prod3, "peter/sample_data.csv")
